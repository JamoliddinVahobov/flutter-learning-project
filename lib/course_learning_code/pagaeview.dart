...
class _MinskState extends State<Minsk> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 4, 70, 146),
      body: Stack(
        children: [
          Positioned(
            child: Container(
          ...
          Positioned(
            child: Container(
              ...
              decoration: BoxDecoration(
                boxShadow: [
                  BoxShadow(
                    color: Color.fromARGB(255, 16, 4, 145),
                    offset: Offset(0, 10),
                    blurRadius: 3,
                  ),
                ],
...
class _LookState extends State<Look> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 3, 60, 203),
      body: Container(
        decoration: BoxDecoration(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                boxShadow: [
                  BoxShadow(
                    color: Color.fromARGB(255, 2, 38, 169),
                    offset: Offset(0, 10),
                    blurRadius: 3,
                  ),
                ],
